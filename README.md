# MePOS Connect Android SDK version 1.25
...
- [MePOS SDK Methods](#mepos-sdk-methods)
  ...
  - [int printRAW(String command)](#int-printrawstring-command)
  - [int printRAW(byte\[\]\[\] data, MePOSPrinterCallback callback)](#int-printrawbyte\[\]\[\]-data-meposprintercallback-callback)
  - [int serialRAW(String command)](#int-serialrawstring-command)
